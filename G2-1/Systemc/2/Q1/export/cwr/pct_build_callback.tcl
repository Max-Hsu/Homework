::namespace eval ::pct::build {
  ...
  proc callback {args} {
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/home/B073040049/Desktop/B073040049_HW2/Q1/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
