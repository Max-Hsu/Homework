...
void * server_thread(void * args){
    ...
    vector<struct FastRetranmissionBind> Recvining_Packet_ACK_CHECK;
    ...
    while(1){
        ...
        if(accumulate_size == file_size){
            ...
            */
            init_i = 0;
            int Fast_retranmission_id = 0;
            struct FastRetranmissionBind A;
            A.RECEVING_PACKET = here->ReceivingPacket;
            A.accumulate_size = 0;
